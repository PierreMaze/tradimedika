...
const renderWithRouter = (initialEntries = ["/products"]) => {
  return render(
    <MemoryRouter initialEntries={initialEntries}>
      <Routes>
        <Route path="/products" element={<RemedyResult />} />
      </Routes>
    </MemoryRouter>,
  );
};
...
describe("RemedyResult", () => {
  ...
  describe("With Symptoms from URL", () => {
    it("should display symptoms from query params", () => {
      ...
      renderWithRouter(["/products?symptoms=fatigue,stress"]);
    ...
    it("should render remedy result list when remedies are found", () => {
      ...
      renderWithRouter(["/products?symptoms=fatigue"]);
  ...
  describe("Empty State", () => {
    ...
    it("should render remedy list component even with no results", () => {
      ...
      renderWithRouter(["/products?symptoms=invalid"]);
