...
export default function FilterTag({ label, isActive, onClick }) {
  return (
    <button
      ...
      type="button"
      className={`animate-scale-in cursor-pointer rounded-md px-3 py-2 text-sm font-medium tracking-wider shadow-md transition-colors duration-150 ease-in-out motion-reduce:animate-none motion-reduce:opacity-100 lg:text-base ${
        isActive
