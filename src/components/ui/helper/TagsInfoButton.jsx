...
function TagsInfoButton({
  ...
  return (
    ...
    >
      ...
      >
        {label && (
          <span className="text-sm font-bold text-neutral-900/50 dark:text-neutral-300">
            {label}
          </span>
        )}
          ...
          <>
            ...
            <AnimatePresence>
              ...
              >
                ...
                {/* Titre */}
                <h3
                  className={`mb-4 text-lg font-bold text-neutral-900 dark:text-neutral-50 ${!isDesktop ? "pr-8" : ""}`}
                >
