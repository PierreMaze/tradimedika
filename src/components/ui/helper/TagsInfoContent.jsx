  ...
  return (
    <div className="border-b-2 border-dashed border-emerald-200 last:border-b-0 dark:border-emerald-700">
      <button
        ...
        className="transition-color flex w-full cursor-pointer items-center justify-between py-4 text-left duration-150 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500"
        ...
        >
          <div className="space-y-4 pb-4">
            {category.options.map((option) => (
              <div
                key={option.id}
                className="transition-color grid grid-cols-1 gap-3 rounded-md p-2 duration-150 lg:grid-cols-3"
              >
                <div className="h-8 shrink-0 lg:col-span-1">{option.tag}</div>
            ...
            <div key={category.id} className="space-y-2">
              ...
              <div className="space-y-3">
                {category.options.map((option) => (
                  ...
                  >
                    <div className="shrink-0">{option.tag}</div>
