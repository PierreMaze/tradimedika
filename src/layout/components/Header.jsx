...
export default function Header() {
  ...
  return (
    <header
      className={`bg-light dark:bg-dark fixed top-0 right-0 left-0 z-100 h-auto w-full transition-transform duration-300 ease-in-out motion-reduce:transform-none ${shouldHide ? "-translate-y-full" : "translate-y-0"}`}
    >
