...
export default function CookieBanner() {
  ...
  return (
    <div
      ...
      aria-live="polite"
      className="animate-fade-in-up fixed right-0 bottom-0 left-0 z-50 bg-white p-4 shadow-2xl motion-reduce:animate-none motion-reduce:opacity-100 md:right-auto md:bottom-4 md:left-4 md:max-w-md md:rounded-lg dark:bg-neutral-900"
    >
      <button
