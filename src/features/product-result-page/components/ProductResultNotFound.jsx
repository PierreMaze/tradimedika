// components/product/ProductResultNotFound.jsx
...
/**
 * Composant d'état vide pour les résultats de produits
 * - Affiche un message personnalisé selon le type (no-results, no-filter-match, product-not-found)
 ...
 */
export default function ProductResultNotFound({
  variant = "no-results",
  ...
  const messages = {
    "no-results": {
      ...
      title: "Aucun produit naturel trouvé pour ces symptômes",
      ...
      suggestions: [
        "Séléctionner d'autres symptômes",
        "Sélectionner d'autres filtres",
        "Réduisez le nombre de symptômes sélectionnés",
        "Réduisez les filtres sélectionnés",
        "Faites un feedback pour nous aider à améliorer la recherche",
      ],
      showPopularSymptoms: true,
    },
    "no-filter-match": {
      icon: HiExclamationTriangle,
      title: "Aucun produit ne correspond au filtre sélectionné",
      description:
        "Essayez de sélectionner un autre badge 'symptôme' pour voir d'autres résultats",
      titleColor: "text-emerald-700 dark:text-emerald-400",
      iconColor: "text-emerald-600 dark:text-emerald-500",
      suggestions: [
        "Sélectionnez le badge 'Tous' pour voir tous les produits",
        "Choisissez un symptôme différent dans la liste des badges",
    ...
    "product-not-found": {
      ...
      title: "Ce produit naturel n'existe pas ou n'est plus disponible",
...
ProductResultNotFound.propTypes = {
