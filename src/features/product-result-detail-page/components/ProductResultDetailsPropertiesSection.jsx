...
function ProductResultDetailsPropertiesSection({ properties }) {
...
ProductResultDetailsPropertiesSection.propTypes = {
...
export default ProductResultDetailsPropertiesSection;
