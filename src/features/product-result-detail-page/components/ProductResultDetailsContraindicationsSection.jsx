...
function ProductResultDetailsContraindicationsSection({ contraindications }) {
...
ProductResultDetailsContraindicationsSection.propTypes = {
  contraindications: PropTypes.arrayOf(PropTypes.string),
};

export default ProductResultDetailsContraindicationsSection;
