...
function ProductResultDetailsAllergyWarning({ allergenNames }) {
  return (
    <div
      role="alert"
      aria-live="assertive"
...
ProductResultDetailsAllergyWarning.propTypes = {
  allergenNames: PropTypes.string.isRequired,
};

export default ProductResultDetailsAllergyWarning;
