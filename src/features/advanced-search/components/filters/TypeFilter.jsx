...
import { PRODUCT_TYPES } from "../../utils/searchConstants";

/**
 * Filtre par type de produit (aliment, plante, épice, boisson)
 */
function TypeFilter({ activeFilters, onToggle }) {
  return (
    <div className="space-y-1">
      {PRODUCT_TYPES.map((type) => (
        ...
        >
          <input
            type="checkbox"
            checked={activeFilters[type.id] || false}
            onChange={() => onToggle("types", type.id)}
