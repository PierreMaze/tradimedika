...
import { PREGNANCY_OPTIONS } from "../../utils/searchConstants";
...
/**
 * Filtre sécurité grossesse (autorisé / précautions / contre-indiqué)
 */
function PregnancyFilter({ activeFilters, onToggle }) {
  return (
      ...
      {PREGNANCY_OPTIONS.map((option) => (
        ...
        >
          <input
            ...
            onChange={() => onToggle("pregnancy", option.id)}
...
PregnancyFilter.propTypes = {
  activeFilters: PropTypes.object.isRequired,
  onToggle: PropTypes.func.isRequired,
};

export default PregnancyFilter;
