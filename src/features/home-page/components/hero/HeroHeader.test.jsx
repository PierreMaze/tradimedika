...
describe("HeroHeader", () => {
  describe("Rendering with default props", () => {
    it("should render with default props", () => {
      ...
      expect(screen.getByText("Version Bêta · v0.50.1")).toBeInTheDocument();
  ...
  describe("Rendering with custom props", () => {
    it("should render custom badgeText", () => {
      ...
      expect(
        screen.queryByText("Version Bêta · v0.50.1"),
  ...
  describe("Structure and layout", () => {
    ...
    it("should render badge in separate container", () => {
      ...
      const badge = screen.getByText("Version Bêta · v0.50.1");
